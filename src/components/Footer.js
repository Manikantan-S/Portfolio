  ...
  return (
    <div className="mt-4 bg-dark-200 rounded-md text-white px-8 py-4">
      <ul className="text-center">
        ...
        <li><a href="#certs" className="hover:underline">Certfications & Projects</a></li>
      </ul>

      <img src={hr} className="mb-4 mt-4 w-full md:h-1 text-white bottom-0" alt="hr" />
      <p className="text-sm font-light text-center">Copyright © 2023 P Karthik Manikantan. All Right Reserved</p>
